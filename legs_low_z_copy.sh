...
head -n 1 /share/nas2/walml/repos/pytorch-galaxy-datasets/notebooks/temp_legs_z_below_0p1_all_files.txt | xargs -I{} -n 1 -P 1 rsync -avR /share/nas2/walml/galaxy_zoo/decals/dr8/jpg/{} low_z_jpg/{}
